...
namespace GoogleImporter.Editor
{
    public abstract class GoogleSheetsImporter
    {
        ...
        protected GoogleSheetsImporter(string spreadsheetId) => _spreadsheetId = spreadsheetId;
        ...
        public async Task DownloadAndParseSheet(string sheetName)
        {
            ...
            if (response is { Values: not null })
            {
                ...
                foreach (var cell in firstRow) _headers.Add(cell.ToString());
            ...
            else Debug.LogWarning($"No data found in Google Sheet: {sheetName}");
        }
