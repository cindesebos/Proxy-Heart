...
public struct DialogueSettings : IFlatbufferObject
{
  ...
  public FlatBuffersSetup.Gameplay.AuthorType AuthorType { get { int o = __p.__offset(6); return o != 0 ? (FlatBuffersSetup.Gameplay.AuthorType)__p.bb.GetSbyte(o + __p.bb_pos) : FlatBuffersSetup.Gameplay.AuthorType.Player; } }
  public string MessageLid { get { int o = __p.__offset(8); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetMessageLidBytes() { return __p.__vector_as_span<byte>(8, 1); }
#else
  public ArraySegment<byte>? GetMessageLidBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public byte[] GetMessageLidArray() { return __p.__vector_as_array<byte>(8); }
  ...
  public static void AddAuthorType(FlatBufferBuilder builder, FlatBuffersSetup.Gameplay.AuthorType authorType) { builder.AddSbyte(1, (sbyte)authorType, 0); }
  public static void AddMessageLid(FlatBufferBuilder builder, StringOffset messageLidOffset) { builder.AddOffset(2, messageLidOffset.Value, 0); }
...
static public class DialogueSettingsVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*AuthorType*/, 1 /*FlatBuffersSetup.Gameplay.AuthorType*/, 1, false)
      && verifier.VerifyString(tablePos, 8 /*MessageLid*/, false)
